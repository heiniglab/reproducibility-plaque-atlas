...
directory_path <- paste0("output/scPower/corrected2/", celltype, "/")
if (!dir.exists(directory_path)) {
  dir.create(path = directory_path, recursive = TRUE)
}

png(filename = paste0("output/scPower/corrected2/", celltype, "/gammafit.png"), width = 800, height = 600)
...
saveRDS(all_gamma_linear_fits, file = "output/scPower/corrected2/all_gamma_linear_fits.rds")
saveRDS(all_disp_fun_general, file = "output/scPower/corrected2/all_disp_fun_general.rds")
